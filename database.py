...
DRIVER = 'postgres' if (DATABASE_URL and DATABASE_URL.startswith(('postgres://','postgresql://'))) else 'sqlite'
...
if DRIVER == 'postgres':
    try:
        ...
        raise RuntimeError("psycopg2-binary не установлен. Добавьте его в requirements.txt") from e
